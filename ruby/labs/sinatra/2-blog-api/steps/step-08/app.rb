...
if User.count == 0
  ...
  10.times do |i|
    ...
    post.tags << ruby_tag if i.even?
    post.tags << sinatra_tag if i % 3 == 0
  end

  puts "Created sample data with pagination test data"
end
...
if __FILE__ == $0
  puts "Starting Blog API with Pagination..."
